            ...
            <div class="card">
                ...
                <div class="m-3">
                    <table class="table">
                        ...
                        <tbody>
                            @if(isset($response["games"]["items"]["list"]))
                                @foreach($response["games"]["items"]["list"] as $game)
                                    <tr>
                                        <th scope="row">1</th>
                                        <td>{{ $game["game_title"] }}</td>
                                        <td>{{ $game["game_key"] }}</td>
                                        <td>
                                            <span id="{{ $game['game_key'] }}" style="display: none;">{{ $game["api_key"] }}</span>
                                        </td>
                                        <td>
                                            <div class="float-end">
                                            <button class="btn btn-sm btn-secondary" onclick="toggleApiKey('{{ $game['game_key'] }}')">Show Key</button>                                     
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach         
...
<script>
    function toggleApiKey(row) {
        const apiKeySpan = document.getElementById(row);
